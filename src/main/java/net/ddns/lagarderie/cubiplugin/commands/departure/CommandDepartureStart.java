...
public class CommandDepartureStart implements TabExecutor {
    @Override
        ...
        if (commandSender instanceof Player player) {
            ...
            for (Track track : Racing.getInstance().getTracks()) {
                if (track.getMapId().equals(worldName)) {
                    ...
                    TrackLocation tl = track.getDepartureLineStart();
                    ...
                    track.setDepartureLineStart(new TrackLocation(location));
